  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between gap-4 mb-3 text-[11px] text-[#14110e]/55">
        <span className="uppercase tracking-[0.2em] text-[#c15a3a]">
          {tag ?? "Guide"}
        </span>
        <span>
      ...
      <h2 className="text-[22px] md:text-[28px] leading-[1.2] tracking-[-0.02em] font-medium text-[#14110e] mb-3 group-hover:text-[#c15a3a] transition-colors">
        {fm.title}
      </h2>
      <p className="text-[14px] md:text-[15px] leading-[1.65] text-[#14110e]/70 mb-4 max-w-[68ch]">
        {fm.description}
      </p>
      <span className="inline-flex items-center gap-1 text-[13px] text-[#c15a3a]">
        Les guiden
