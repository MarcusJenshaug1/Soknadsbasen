          ...
          <div className="absolute bottom-full left-0 right-0 mb-1 bg-bg border border-black/10 dark:border-white/10 rounded-2xl shadow-lg overflow-hidden z-40">
            {activeSession && (
              <div className="px-4 py-3 border-b border-black/8 dark:border-white/8">
                <div className="text-[10px] uppercase tracking-wider text-ink/45 mb-2">Denne sesjonen</div>
                <button
            ...
            {closedSessions.length > 0 && (
              <div className="px-4 py-3 border-b border-black/8 dark:border-white/8 max-h-48 overflow-y-auto">
                <div className="text-[10px] uppercase tracking-wider text-ink/45 mb-2">Tidligere sesjoner</div>
            ...
            <div className="px-4 py-3">
              {!activeSession ? (
                <button
                  ...
                  className="w-full px-3 py-2 rounded-xl text-[12px] bg-accent text-bg hover:bg-accent-hover transition-colors"
                >
                  Start ny sesjon
                </button>
              ) : (
