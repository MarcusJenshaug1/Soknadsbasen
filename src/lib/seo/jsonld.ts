...
export function webApplicationJsonLd(): JsonLd {
  ...
  return {
    ...
    featureList: [
      ...
      `AI-assistert søknadsbrev (${aiCredits.monthlyIncluded} AI-kreditter per måned inkludert)`,
    ...
    offers: [
      ...
      {
        "@type": "Offer",
        name: `AI-påfyll ${aiCredits.topup50.credits} AI-kreditter`,
        price: aiCredits.topup50.amount,
        priceCurrency: aiCredits.topup50.currency,
        category: "one-time",
        availability: "https://schema.org/InStock",
        eligibleRegion: { "@type": "Country", name: "NO" },
        description: `${aiCredits.topup50.credits} ekstra AI-kreditter, krever aktivt abonnement. Utløper aldri.`,
      },
      {
        "@type": "Offer",
        name: `AI-påfyll ${aiCredits.topup100.credits} AI-kreditter`,
        price: aiCredits.topup100.amount,
        priceCurrency: aiCredits.topup100.currency,
        category: "one-time",
        availability: "https://schema.org/InStock",
        eligibleRegion: { "@type": "Country", name: "NO" },
        description: `${aiCredits.topup100.credits} ekstra AI-kreditter, krever aktivt abonnement. Utløper aldri.`,
      },
    ],
  };
}
