...
export const COMPETITORS: Competitor[] = [
  {
    slug: "jobbe-ai",
    name: "Jobbe.ai",
    homepage: "https://jobbe.ai",
    shortName: "Jobbe.ai",
    category: "AI + CV + tracker",
    publishedAt: "2026-04-29",
    intro: [
      "Jobbe.ai (også markedsført som Lonna) er den eneste norske aktøren i dag som dekker det samme tre-pilars-konseptet som Søknadsbasen, AI-søknadsbrev, CV-bygger og søknadsoversikt i én plattform. Det gjør dem til den mest direkte sammenligningen du kan gjøre.",
      "Vi sammenligner ærlig: hva Jobbe.ai gjør bra, hvor Søknadsbasen skiller seg, og hva som faktisk gir best verdi for kronen i 2026.",
    ],
    whatItIs: [
      "Jobbe.ai er en norsk hybrid-plattform med AI-søknadsbrev, CV-bygger, jobboversikt og lønnsassistent. De trekker stillinger fra hele Norge og Skandinavia, inkludert Finn-annonser. Plattformen drives som Lonna under panseret, noe som har skapt litt forvirring i merkevaren.",
      "Søknadsbasen kombinerer CV-bygger (åtte maler), AI-assistert søknadsbrev med versjonshåndtering per arbeidsgiver, pipeline med kanban og listevisning, oppgaver og frister, og innsikt i hvor intervjuene faktisk kommer fra.",
    ],
    comparisonTable: [
      { feature: "Pris (per måned)", soknadsbasen: "79 kr", competitor: "299 kr" },
      { feature: "Pris (årlig snitt)", soknadsbasen: "79 kr/mnd", competitor: "249 kr/mnd" },
      { feature: "Engangskjøp", soknadsbasen: "299 kr / 6 mnd full tilgang", competitor: "249 kr / 20 AI-genereringer" },
      { feature: "Gratis prøveperiode", soknadsbasen: "7 dager full tilgang", competitor: "3 søknadsbrev og 3 CV-sammendrag" },
      { feature: "CV-bygger", soknadsbasen: "8 maler", competitor: "1 mal i basis-tier" },
      { feature: "AI-søknadsbrev", soknadsbasen: "yes", competitor: "yes" },
      { feature: "Versjonshåndtering brev", soknadsbasen: "Auto per arbeidsgiver", competitor: "partial" },
      { feature: "Pipeline med kanban", soknadsbasen: "yes", competitor: "Listevisning" },
      { feature: "ATS-vennlig PDF-eksport", soknadsbasen: "yes", competitor: "yes" },
      { feature: "Jobbaggregator inkludert", soknadsbasen: "no", competitor: "yes", note: "Jobbe.ai trekker stillinger fra Finn etc." },
      { feature: "Lønnsassistent", soknadsbasen: "no", competitor: "yes" },
      { feature: "Klar merkevare", soknadsbasen: "Søknadsbasen", competitor: "Forvirring (Jobbe.ai/Lonna)" },
    ],
    competitorStrengths: [
      "Eneste norske aktør som samler CV, AI-søknadsbrev og søknadstracker i samme verktøy.",
      "Innebygd jobbaggregator som trekker stillinger fra Finn og andre kilder.",
      "Lønnsassistent som ekstra funksjon, nyttig for forhandling.",
      "Norsk språkforståelse og UI, ingen oversettelse-rusk.",
    ],
    competitorWeaknesses: [
      "Pris på 249 til 299 kr per måned er omtrent 3x dyrere enn Søknadsbasen.",
      "Forvirrende merkevare-struktur: markedsført som Jobbe.ai, men plattformen heter Lonna.",
      "Kun 1 CV-mal i basis-tier mot 8 hos Søknadsbasen.",
      "Engangskjøp på 249 kr gir kun 20 AI-genereringer, ikke full tilgang som hos Søknadsbasen.",
      "Liten brukerbase synlig (46 likes på Facebook per 2026), uklart om plattformen skalerer.",
    ],
    soknadsbasenStrengths: [
      "Klar, ren merkevare uten dobbel-identitet.",
      "Tydelig prising: 79 kr/mnd eller 299 kr engangs for 6 måneders full tilgang, ingen oppsalg.",
      "8 CV-maler med 6 fargepaletter, ikke 1 mal i basis.",
      "Kanban-pipeline med visuell statusflyt, mer enn bare en liste.",
      "Versjonshåndtering av søknadsbrev koblet automatisk til arbeidsgiver, ingen manuell file-versjonering.",
    ],
    whenToChooseCompetitor:
      "Velg Jobbe.ai hvis du verdsetter integrert jobbaggregator (slipper å åpne Finn separat) og lønnsassistent, og er villig til å betale 3x premium for de tilleggsfunksjonene. Også et valg hvis du allerede er etablert på Lonna-plattformen og ikke vil migrere.",
    whenToChooseSoknadsbasen:
      "Velg Søknadsbasen hvis du vil ha samme tre kjernepillarer (CV, AI-søknadsbrev, tracker) til en tredjedel av prisen, foretrekker visuell kanban-pipeline foran flat liste, og setter pris på en plattform med klar identitet og gjennomsiktig prising.",
    faq: [
      {
        q: "Hva er forskjellen på Jobbe.ai og Lonna?",
        a: "Det er samme plattform med to navn. Jobbe.ai er det utadrettede merkenavnet, mens selve appen ofte refereres til som Lonna. Det skaper forvirring rundt hvilken side du faktisk skal logge inn på, og fakturering kan komme fra ulike enheter.",
      },
      {
        q: "Kan jeg flytte CV-er fra Jobbe.ai til Søknadsbasen?",
        a: "Ja. Eksporter CV-en din som PDF fra Jobbe.ai, last opp som referanse i Søknadsbasen, eller skriv inn dataene manuelt i én av Søknadsbasens 8 maler. Mange felter gjenkjennes automatisk fra eksisterende CV-er.",
      },
      {
        q: "Er Jobbe.ai dyrere enn det ser ut?",
        a: "Standard månedspris er 299 kr, og selv årlig fakturering lander på 249 kr per måned. Det er omtrent 3x mer enn Søknadsbasens 79 kr/mnd. Engangskjøpet på 249 kr gir kun 20 AI-genereringer, mens Søknadsbasens 299 kr engangs gir 6 måneders full tilgang.",
      },
      {
        q: "Hvilket av verktøyene har bedre AI-søknadsbrev?",
        a: "Begge bruker moderne språkmodeller. Søknadsbasen har versjonshåndtering automatisk koblet til arbeidsgiver, slik at hver søknad lever som egen versjon i pipelinen. Jobbe.ai håndterer dette mer manuelt.",
      },
    ],
  },
  {
