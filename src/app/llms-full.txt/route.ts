...
export async function GET() {
  ...
  const overview = [
    ...
    `6. **AI-assistanse**. Valgfri hjelp til CV-forbedring, stilling-analyse, søknadsbrev-drafting, intervjuforberedelse og oppfølgings-e-post. Drives av Anthropic Claude.`,
    ``,
    `## Filosofi`,
    ``,
    ...
    `- Anthropic Claude (USA) kun når brukeren aktivt bruker AI-funksjoner. Eneste behandling utenfor EU; overføres under SCC, lagres ikke og brukes ikke til trening.`,
    ``,
