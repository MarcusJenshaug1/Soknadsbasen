...
import {
  ...
  ClosingCTA,
  PricingCTA,
} from "@/components/marketing/LandingCTAs";
...
const FAQ = [
  ...
  {
    q: "Hva koster det?",
    a: "79 kr per måned med 7 dagers gratis prøveperiode, eller 299 kr for 6 måneders tilgang som engangsbetaling. Begge inkluderer 150 AI-kreditter per måned, og engangsvarianten fornyes ikke automatisk.",
  },
  {
