...
1. Ta KUN med data som står eksplisitt i kildeteksten. Ikke finn på, ikke utled, ikke "oversett" mellom språk.
2. Hvis et felt ikke finnes i kildeteksten, bruk tom streng "" eller tom array [].
3. Ikke parafraser beskrivelser — kopier teksten slik den står, med radbrekk bevart via \\n.
